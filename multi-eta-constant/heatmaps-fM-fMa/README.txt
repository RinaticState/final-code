...
No eta function, with Ludewig trafficking rate.
All the code in this folder will generate a heatmap of fM and fMa parameters for the multicompartmental model of Type I Diabetes code.
...
To prove that a certain region is diabetic/glycemic/healthy, run the dynamics function by picking a point in a certain region. Think of it as an (x, y) coordinate, with the x being the fMa, and y being fM.
dynamics(0.1, 1, 0)
