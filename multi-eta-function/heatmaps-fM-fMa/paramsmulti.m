...
muB = 26.976; %Dendritic cell emigration rate from blood to spleen: 1/day;
...
fM = getappdata(0,'fM_var');
fMa = getappdata(0,'fMa_var');
fMs = 0.0623*fM*10^(-5);
fMas = 0.0623*fMa*10^(-5);
